...
class _SignInPageState extends State<SignInPage> {
  ...
  Column centerContent(Size size) {
    return Column(
      ...
      children: [
        SvgPicture.asset('assets/images/21585853_indonov118.svg', height: size.height * 0.30),
    ...
    return Padding(
      ...
      child: CustomAnimatedButton(
        onTap: () async {
          ...
          if (isValid) {
            var result = await controller.signInWithEmailAndPassword(user);
            // checa se o profissional já está ativo no sistema
            var estaAtivo = await checkProfissionalLogon(user.email);
            ...
            if (result && estaAtivo)
            {
              ...
              alertDialog(
                  ...
                  'Usuário ou senha inválidos.Por favor verifique com o administrador o seu acesso.');
