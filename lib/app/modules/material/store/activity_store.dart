...
abstract class _ActivityStore with Store {
  ...
  @action
  recoverActivityData(idAtividade) async {
    _repository.recoverActivityData(idAtividade);
      atividadeModel = await _repository.recoverActivityData(idAtividade);
    }
  }
